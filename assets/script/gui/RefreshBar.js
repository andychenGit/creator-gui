...
var RefreshBar = cc.Class({
    ...
    updateState( coreTable, state ){
        ...
        if (state == Agui.TableView.RefreshState.DROP_REFRESH) {
            ...
            this.node.position = cc.v2(offset.x, size.height)
            ...
            let viewSize = coreTable.node.getContentSize()
            this.node.parent = this.coreTable.node
            this.node.position = cc.v2(-viewSize.width*0.5, viewSize.height*0.5 - this.node.height)
